...
> **Statut : prépublication alpha 0.2.4.** Cette version est destinée aux fichiers virtuels, aux démonstrations et au développement. N’utilisez pas `diskpurge` sur un support réel ou sur des données client avant d’avoir satisfait les critères de qualification matérielle et de publication du projet.
