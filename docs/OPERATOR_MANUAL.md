...
diskpurge 0.2.3 est une alpha destinée aux fichiers virtuels et au développement. Le binaire standard ne contient actuellement aucun tuple matériel réel qualifié. Il refuse donc l’effacement de tout disque physique, même si les autres contrôles sont satisfaits.
