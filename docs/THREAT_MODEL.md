...
Ce modèle couvre le code 0.2.4 présent dans la branche principale. Il doit être revu pour chaque changement de sélection du support, de commande destructive, de vérification, d’audit ou de privilèges.
