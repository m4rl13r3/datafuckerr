...
La version 0.2.0 reste une alpha. Elle possède désormais une vérification complète par défaut, une validation stricte de full/sample, une réinspection de l’identité, un acquittement explicite et un audit chaîné vérifiable. Elle ne satisfait notamment pas les barrières P0 relatives à une revalidation liée au descripteur ouvert, à la protection Windows, à la qualification matérielle, à la reprise persistante après interruption, à l’authenticité externe de l’audit et à la chaîne de publication.
