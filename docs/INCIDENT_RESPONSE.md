...
La version 0.2.1 standard n’est pas autorisée sur les disques clients et ne contient aucun tuple matériel réel qualifié. Un incident sur support réel pendant une expérimentation reste néanmoins traité comme critique. Le mode `-lab` ne réduit ni l’obligation de confinement ni celle de conserver les preuves.
