...
~~~sh
sha256sum --check diskpurge-0.2.3-linux-x64.sha256
sha256sum --check datafuckerr-0.2.3-linux-x64.AppImage.sha256
gh attestation verify diskpurge-0.2.3-linux-x64.tar.gz --repo propriétaire/diskpurge
gh attestation verify datafuckerr-0.2.3-linux-x64.AppImage --repo propriétaire/diskpurge
~~~
