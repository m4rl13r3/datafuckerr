...
L’image ne contient jamais le mode laboratoire. La table de qualification physique de la version 0.2.1 est vide : même démarré depuis l’ISO, datafuckerr refuse donc tout effacement de support physique. Les fichiers virtuels restent utilisables pour les démonstrations non destructives.
