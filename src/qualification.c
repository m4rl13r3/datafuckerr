...
static const dfx_qualification qualifications[] = {
    ...
    {DFX_BUILD_VERSION, "test", "MODÈLE-QUALIFIÉ", "FW-1", "SATA", "SYSTÈME-TEST", "TOPOLOGIE-TEST", DFX_MEDIA_HDD, DFX_METHOD_CLEAR_ZERO, DFX_NATIVE_NONE, 1000000U, 512U, true, "Q3-TEST-001"},
#endif
